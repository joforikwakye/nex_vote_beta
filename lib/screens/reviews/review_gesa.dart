...
class ReviewGesaScreen extends StatelessWidget {
  const ReviewGesaScreen({Key key}) : super(key: key);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: ListTile(
                leading: ClipRRect(
                  ...
                  child: Image.network(context
                      .watch<UserProvider>()
                      .gesaVotes["president"]["imageUrl"]),
                ),
                title: Text(
                  context.watch<UserProvider>().gesaVotes["president"]["name"],
            ...
            Container(
              ...
              child: ListTile(
                leading: ClipRRect(
                  ...
                  child: Image.network(context
                      .watch<UserProvider>()
                      .gesaVotes["finSec"]["imageUrl"]),
                ),
                title: Text(
                  context.watch<UserProvider>().gesaVotes["finSec"]["name"],
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
              ),
            ),
            ...
            Container(
              ...
              child: ListTile(
                leading: ClipRRect(
                  ...
                  child: Image.network(context
                      .watch<UserProvider>()
                      .gesaVotes["genSec"]["imageUrl"]),
                ),
                title: Text(
                  context.watch<UserProvider>().gesaVotes["genSec"]["name"],
            ...
            context.watch<UserProvider>().votesSubmittedGesa == false
                ? Center(
                    child: ClipRRect(
